  ...
  PopupTemplate, GraphicsLayer, webMercatorUtils
    ...
    return declare([GraphicsLayer], {
        constructor: function (options) {
            ...
            this._clusterDataArray = options.data || [];
            this._clusters = [];
            this._clustersArray = [];
            ...
            this._symbol = options.symbols || ["green", "blue"];
            this._defaultSymbol = null;
            this._zoomEnd = null;
            var tmp;
        },
        ...
        _clusterGraphics: function () {
            ...
            for (var m = 0; m < this._clusterDataArray.length; m++) {
                ...
                tmp = this._clusters.slice(0);
                this._clustersArray.push(tmp);//(tmp);
                // this._clusters.length = 0;
            }
        ...
        _clusterAddPoint: function (p, cluster) {
            ...
            // debugger;
            if (cluster.attributes.number != undefined)
                cluster.attributes.number += p.attributes.数量;
        ...
        _showCluster: function (c, tp) {
            ...
            if (c.attributes.clusterCount == 1 && c.attributes.number == undefined) {
                return;
            }

            // show number of points in the cluster
            var showLabel = c.attributes.clusterCount;
            //  debugger;
        ...
        _updateLabel: function (c) {
            ...
            if (label.length == 1) {
                ...
                var newLabel = new TextSymbol(showLabel.toString())
                .setColor(new Color(this._clusterLabelColor))
                .setOffset(0, this._clusterLabelOffset);
                this.add(
                  new Graphic(
