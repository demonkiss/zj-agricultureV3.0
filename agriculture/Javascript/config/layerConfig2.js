var layerConfig = {
    "粮食生产功能区": {
        ...
        "功能区级别": {
            "url": "http://126.11.9.238:8080/ArcGIS/rest/services/LS/MapServer",
            "array": [0],
            "fieldInfos": [{
                "fieldName": "认定编号",
                "label": "认定编号",
    ...
    "现代农业园区": {
        ...
        "现代农业综合区": {
            "url": "http://126.11.9.238:6080/arcgis/rest/services/ls_2000/MapServer",
            "array": [0],
            "fieldInfos": [{
                "fieldName": "认定编号",
                "label": "认定编号",
        ...
        "主导产业示范区": {
            "url": "http://126.11.9.238:8080/ArcGIS/rest/services/YQ/MapServer",
            "array": [0],
            "fieldInfos": [{
                "fieldName": "名称",
                "label": "名称",
    ...
    "标准农田": {
        ...
        "千万亩工程项目": {
            "url": "http://126.11.9.238:8080/ArcGIS/rest/services/BZNT/MapServer",
